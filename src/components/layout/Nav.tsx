...
export function Nav() {
  ...
  return (
    <header className="fixed top-2 left-2 right-2 z-[80] bg-background/90 backdrop-blur-2xl border border-foreground/10 rounded-2xl overflow-hidden shadow-[0_8px_24px_-12px_hsl(var(--foreground)/0.18)]">
