    ...
    <PageShell>
      <section ref={ref} className="px-5 md:px-8 pt-[120px] md:pt-[160px]">
        ...
        <motion.div style={{ y: yFast }} className="mt-10 md:mt-16 space-y-4 md:space-y-6">
          <div className="pb-2 w-fit" style={{ clipPath: "inset(0 0 -16px 0)", overflow: "hidden" }}>
            <motion.a
              ...
              style={{ fontFamily: '"Hanken Grotesk", sans-serif', fontSize: "clamp(2.28rem, 4.2vw, 5.1rem)" }}
              initial={{ opacity: 0, y: 32 }}
              animate={{ opacity: 1, y: 0 }}
