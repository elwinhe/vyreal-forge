      ...
      <section ref={ref} className="px-5 md:px-8 pt-10 md:pt-16">
        ...
        <motion.div style={{ y: yFast }} className="mt-6 space-y-4 md:space-y-6">
          <a
            ...
            className="block w-fit display font-light text-[12vw] md:text-[9vw] tracking-display leading-[0.9] text-[hsl(var(--muted-ink))] relative after:content-[''] after:absolute after:left-0 after:right-0 after:-bottom-0.5 after:h-[7px] after:bg-accent after:origin-left after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
          >
            work@vyreal.ai
          </a>
          <a
